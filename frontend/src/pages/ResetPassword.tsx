        ...
        <div className={`max-w-md w-full bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-8 space-y-8 border border-white/10 ${reduceMotion ? '' : 'animate-slideDown'}`}>
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-center text-4xl font-extrabold text-white mb-2">
              Reset Your{' '}
              <span className="bg-gradient-to-r from-teal-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent">Password</span>
            </h2>
            <p className="mt-2 text-center text-sm text-slate-200">Username</p>
            <p className="text-center text-sm font-semibold text-teal-300 mt-1">{username}</p>
          </div>
